const mockResults = [
  {
    ...
    links: {
      ...
      children: [
        { group: 'Group-MRT', pseudonym: 'BLV-MRT-3843732', children: [] },
        { group: 'Group-Labor', pseudonym: 'BLV-Labor-8674536', children: [] },
        { group: 'Group-EEG', pseudonym: 'BLV-EEG-1827365', children: [] },
        { group: 'Group-Screening', pseudonym: 'BLV-S-3746586', children: [] }
      ]
    },
    identifiers: {
      id: '3647659283',
...
export default PersonServiceMock;
